...
class ClientActor extends Actor{
	...
	case START =>
     ...
     master ! SendInfo("Oliver Twist", "http://reed.cs.depaul.edu/lperkovic/csc536/homeworks/gutenbergs/pg730.txt")
     master ! SendInfo("The Old Curiosity Shop", "http://reed.cs.depaul.edu/lperkovic/csc536/homeworks/gutenbergs/pg700.txt")
     master ! SendInfo("David Copperfield", "http://reed.cs.depaul.edu/lperkovic/csc536/homeworks/gutenbergs/pg766.txt")
     master ! SendInfo("The Life And Adventures Of Nicholas Nickleby", "http://reed.cs.depaul.edu/lperkovic/csc536/homeworks/gutenbergs/pg967.txt")
     master ! SendInfo("A Child's History of England", "http://reed.cs.depaul.edu/lperkovic/csc536/homeworks/gutenbergs/pg699.txt")
