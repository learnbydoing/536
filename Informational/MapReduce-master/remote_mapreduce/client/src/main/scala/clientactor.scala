...
class ClientActor extends Actor{
  ...
  println("In client.scala, Remote Reducers: " + reduceActors.toString)
  ...
  println("In clientactor.scala, client has URVI sent the reducers to the master actor ...")
  ...
  def setMapActors(reducers: List[ActorRef]): Unit = {
    ...
    println("In client.scala, Remote Mappers: " + mapActors.toString)
  }
  ...
  def receive = {
    ...
    case Done => 
      ...
      master ! Done
    case START =>
      println("Calling MAP in clientactor.scala")
